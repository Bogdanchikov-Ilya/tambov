    ...
    <div class="container">
      <div class="auth">
        ...
        <form action="#" class="form">
          <div class="form-item">
            <label class="popup-item__label" for="login">логин <sup>*</sup></label>
            <input type="text" class="auth-item__input" id="login" name="login">
          </div>
          <div class="form-item">
            <label class="auth-item__label" for="password">пароль <sup>*</sup></label>
            <div class="input-password__wrapper">
              <input :type="showPassword" class="auth-item__input" id="password" name="password">
              <svg viewBox="0 0 20 13" xmlns="http://www.w3.org/2000/svg" v-if="showPassword === 'password'" @click="password(showPassword)">
              ...
              <svg viewBox="0 0 22 17" xmlns="http://www.w3.org/2000/svg" v-if="showPassword === 'text'" @click="password(showPassword)">
        ...
        <router-link to="/registerations" class="register btn-secondary">Зарегистрироваться</router-link>
      </div>
    </div>
  </div>
</template>
