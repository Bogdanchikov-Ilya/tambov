      ...
      <div class="popup">
        ...
        <form action="#" class="popup-form" @submit="createApp">
          <div class="form-item">
            ...
            <label class="form-item__label" for="title"
              >заголовок <sup>*</sup></label
            >
            <input
              type="text"
              ...
              name="title"
            />
            <p v-if="submittedTitle && !$v.title.required" class="msg-error">
              Заполните это поле
            </p>
          </div>
          <div class="form-item">
            <label class="popup-item__label" for="text"
              >текст заявки <sup>*</sup></label
            >
            <textarea
              id="text"
              name="title"
              ...
              :class="{ error: submittedTextarea && !$v.textarea.required }"
            ></textarea>
            <p
              v-if="submittedTextarea && !$v.textarea.required"
              class="msg-error textarea"
            >
              Заполните это поле
            </p>
          </div>
  ...
  methods: {
    ...
    createApp(e) {
      ...
      if (this.$v.title.required && this.$v.textarea.required) {
        ...
        // обновляю список
        this.appServices.loadApplications({
          token: localStorage.getItem("token"),
        });
