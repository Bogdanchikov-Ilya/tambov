<template>
  <div>
    <div
      ...
      :class="{
        bottom:
          (submitted && !$v.passwordValue.required) ||
          (submitted && !$v.passwordValue.minLength),
      }"
    >
      ...
      <div class="input-password__wrapper">
        <input
          ...
          name="password"
        />
        <p class="msg-error" v-if="submitted && !$v.passwordValue.required">
          Заполните это поле
        </p>
        <p class="msg-error" v-if="submitted && !$v.passwordValue.minLength">
          Минимум 6 символов
        </p>
        <svg
          viewBox="0 0 20 13"
        ...
        >
          <path
            d="M19.8729 6.10328C19.6942 5.85402 15.4371 0 9.99991 0C4.56275 0 0.305392 5.85402 0.126914 6.10304C-0.0423048 6.33952 -0.0423048 6.66025 0.126914 6.89672C0.305392 7.14598 4.56275 13 9.99991 13C15.4371 13 19.6942 7.14594 19.8729 6.89692C20.0424 6.66048 20.0424 6.33952 19.8729 6.10328ZM9.99991 11.6552C5.99486 11.6552 2.52606 7.76975 1.49922 6.49954C2.52473 5.22822 5.98627 1.34482 9.99991 1.34482C14.0048 1.34482 17.4733 5.22957 18.5006 6.50046C17.4751 7.77174 14.0136 11.6552 9.99991 11.6552Z"
            fill="#999999"
          />
          <path
            d="M9.99991 2.46552C7.81858 2.46552 6.04385 4.27544 6.04385 6.50002C6.04385 8.7246 7.81858 10.5345 9.99991 10.5345C12.1812 10.5345 13.956 8.7246 13.956 6.50002C13.956 4.27544 12.1812 2.46552 9.99991 2.46552ZM9.99991 9.18966C8.54561 9.18966 7.36256 7.98312 7.36256 6.50002C7.36256 5.01692 8.54565 3.81038 9.99991 3.81038C11.4542 3.81038 12.6373 5.01692 12.6373 6.50002C12.6373 7.98312 11.4542 9.18966 9.99991 9.18966Z"
            fill="#999999"
          />
        </svg>
        <svg
    ...
    <div class="form-item" v-if="repeatBlock">
      <label class="reg-item__label" for="repeat-password"
        >повторите пароль <sup>*</sup></label
      >
      <div class="input-password__wrapper">
        <input
          :type="showPassword"
          ...
          :class="{
            error:
              (submitted && !$v.repeatPasswordValue.required) ||
              (submitted && !$v.repeatPasswordValue.sameAsPassword),
          }"
          @input="checkValidPassword()"
          id="repeat-password"
        ...
        <p
          ...
          v-if="
            submitted &&
            !$v.repeatPasswordValue.required &&
            $v.repeatPasswordValue.sameAsPassword
          "
        >
          Заполните это поле
        </p>
        <p
          class="msg-error"
          v-if="submitted && !$v.repeatPasswordValue.sameAsPassword"
        >
...
export default {
    ...
    checkValidPassword() {
      ...
      if (!this.repeatBlock && this.passwordValue.trim() !== "") {
        if (this.$v.passwordValue.required && this.$v.passwordValue.minLength) {
          ...
          this.$emit("auth", { password: "" });
        }
      } else {
        if (
          this.passwordValue !== this.repeatPasswordValue &&
          this.passwordValue.trim() !== ""
        ) {
  ...
  mounted() {
    this.repeat ? (this.repeatBlock = "Repeat") : this.repeatBlock;
  },
  validations: {
    passwordValue: {
      required,
